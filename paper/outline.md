...
## Results  
Analysis of time from birth until registration showed that there was a remarkable amount of variability in the distribution of births at each municipality mean_time sd_time. In addition to this variability there was a strong geographic correlation between the time delay of births until time to registration with a Moran's I of ttrmoransi, indicating that there is some underlying geographic pattern driving the high variability.
